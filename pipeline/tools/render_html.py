...
TICKER_DESCRIPTIONS = {
    ...
    "4958.TW":  "臻鼎-KY (4958) — 載板 / PCB (Vera Rubin)",
    "2368.TW":  "金像電 (2368) — 載板 / GPU PCB (Vera Rubin)",
    "3324.TWO": "雙鴻 (3324) — 散熱模組",
    "8996.TW":  "高力 (8996) — 散熱 / 熱交換器",
    "3017.TW":  "奇鋐 (3017) — 散熱模組",
    "3653.TW":  "健策 (3653) — 均熱片 / Cold Plate (Vera Rubin)",
    "6805.TW":  "富世達 (6805) — 散熱 / 液冷 (Vera Rubin)",
    "6669.TW":  "緯穎 (6669) — AI server ODM",
    "3231.TW":  "緯創 (3231) — AI server ODM",
    "2356.TW":  "英業達 (2356) — AI server ODM",
    "2376.TW":  "技嘉 (2376) — AI server ODM (Vera Rubin Rack)",
    "2301.TW":  "光寶科 (2301) — 電源 / PSU (Vera Rubin 800V HVDC)",
