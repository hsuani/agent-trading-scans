...
NAMES = [
    ...
    (r"earnings (release|call|report)|法說|財報|earnings|guidance|investor (day|relations)|\bir\b|press release|news release|pr newswire|business ?wire|globe ?newswire|announcement|newsroom|news room|(company|corporate|official|public) (release|disclosure|filing)|public filing|annual report|quarterly report|shareholder letter|公告|公開(揭露|資訊|財務)|disclosure|月營收|monthly revenue|twse|tpex|mops|證券交易所|櫃買|年報|季報|proxy statement|conference (call|organizer)|ieee|vlsi|isscc|hot chips", "A"),
    (r"trendforce|idc|gartner|semianalysis|counterpoint|canalys|omdia|techinsights|digitimes|yole|s&p global|moody|fitch|iea\b|nerc|pjm|ercot|futurum|fusion worldwide|naddod|industry (research|statistics|association)|產業(研究|統計|協會)|tpca|semi\b|dell'oro|lightcounting|jpr\b|research ?and ?markets|researchandmarkets|trading economics|statista|mordor|grand view|markets ?and ?markets|bloombergnef|wood mackenzie|rystad", "B"),
    (r"reuters|bloomberg|wsj|wall street journal|financial times|\bft\b|cnbc|marketwatch|barron|seeking ?alpha|motley|yahoo|benzinga|tipranks|zacks|morningstar|nikkei|鉅亨|cnyes|經濟日報|工商時報|自由時報|中央社|科技新報|technews|newtalk|udn|ettoday|now ?news|digitimes|analyst|broker|券商|外資|大行|美系|goldman|morgan stanley|jpmorgan|jp morgan|bofa|美銀|bank of america|citi|ubs|barclays|jefferies|bernstein|wedbush|kgi|凱基|元大|富邦|永豐|豐雲|國泰|統一|群益|wall street|華爾街|consensus|共識|yfinance|stockstats|refinitiv|factset|lseg|"
     r"market data|市場數據|financial (statements?|data|metrics)|balance sheet|cash ?flow statement|income statement|technical (analysis|indicators|data)|技術(面|指標|分析)|price action|indicators?|fundamentals analysis|ownership|insider (trading|transaction)|institutional|機構持股|持股數據|交易資料|valuation data|"
     r"investing\.com|fintel|biggo|優分析|uanalyze|data center dynamics|datacenterdynamics|capital advisory|news analysis|finviz|macrotrends|gurufocus|simply wall|stockanalysis|marketbeat|nasdaq\.com|wsj|tipranks|whalewisdom|13f", "C"),
